...
questão, serão utilizados alguns gráficos para identificar a relação entre a
CWE476 com o número de módulos de uma versão, para que se possa definir um
modelo próximo ao real. Foram escolhidos alguns gráficos para iniciar esta
análise, baseado no 4 \textit{plots} apresentado pelo NIST (\textit{National
Institute of Standards and Technology}), como pode ser visto na figura
\ref{fig:cwe476-4-plot}.

...
\begin{table}[h]
\centering
\resizebox{\textwidth}{!}{\begin{tabular}{cccl}
 & \cellcolor[HTML]{EFEFEF}{Referência a ponteiros nulos} &
 \cellcolor[HTML]{EFEFEF}{Variáveis não inicializadas} &
 \multicolumn{1}{c}{\cellcolor[HTML]{EFEFEF}{Vazamento de memória}} \\
\cellcolor[HTML]{EFEFEF}{Referência a ponteiros nulos} & 1 & \multicolumn{1}{l}{} &  \\
\cellcolor[HTML]{EFEFEF}{Variáveis não inicializadas} & 0.01902783 & 1 &  \\
\cellcolor[HTML]{EFEFEF}{Vazamento de memória} & - 0.1286109 & 0.5671033 & \multicolumn{1}{c}{1}
\end{tabular}}
...
Analisando o gráfico pode-se observar que, como foi percebido com a
...
\section{Evolução dos Modelos de Predição}\label{evolucao_modelos}

Tendo em vista os modelos definidos e comparados no decorrer deste capítulo,
explorou-se uma outra abordagem, onde serão apresentadas curvas de
...
Como pode-se ver nas Figuras \ref{fig:cwe476_geral} e \ref{fig:cwe457_geral}, e
como foi discutido anteriormente, quanto maior o grau do modelo, menor será o
erro de predição na maioria dos casos. Esta abordagem pode auxiliar na seleção
de um modelo não linear para cada uma das métricas, podendo ser uma continuidade
do trabalho apresentado durante este capítulo. Pode-se considerar o custo
benefício da diminuição do erro de predição do modelo com a complexidade do
mesmo, o que deve aumentar o tempo de predição. Entretanto, a validação desta
abordagem não faz parte do escopo deste trabalho.

...
Percebe-se claramente que a distribuição referente a esta taxa não se assemelha
...
\subsection{Definição dos Modelos}
...
Foi utilizado o método de \citeonline{tukey:1977} apresentado na seção \ref{tukey},
...
Na tabela \ref{tab:cwe476-erros} são resumidos os erros de cada um dos modelos
definidos a partir do conjunto de dados da CWE476.

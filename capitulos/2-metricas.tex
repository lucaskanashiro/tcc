...
estatística subjetiva ~\cite{meirelles2013}. Segundo \emph{Fenton e Pfleenger}
(\citeyear{fenton&pfleenger98}), existem quatro tipos de dados de medidas
...
\begin{itemize}
  ...
  \item \textbf{NPA}: Mede basicamente o encapsulamento de uma classe. Independente da linguagem, é desejado que este valor 
...
As métricas de \textit{design} possuem relevância nesse trabalho pelo fato de que existem três causas básicas que podem surgir 
...
do sistema ~\cite{malerba2010}. Portanto, as métricas de \textit{design} possuem um papel importante para se evitar vulnerabilidades 
em um software.
...
brechas para possíveis atacantes, foi o caso apresentado por \emph{Aranha}
(~\citeyear{aranha2012}) no relatório sobre vulnerabilidades 

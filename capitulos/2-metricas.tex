...
\begin{itemize}
  \item \textbf{AN (Argument with 'nonnull' attribute passed null - Argumento com atributo não nulo passado nulo)}
  \item \textbf{ASOM (Allocator sizeof operand mismatch - Operador incompatível com alocador sizeof)}
  \item \textbf{AUV (Assigned value is garbage or undefined - Valor atribuído é lixo ou indefinido)}

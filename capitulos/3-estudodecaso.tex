...
diferentes, respeitando os únicos requisito de possuir a linguagem de programação C/C++ como
...
a mesma está presente em todos os projetos. Além de ser frequênte entre os projetos, essa métrica também
...
locais de memória que já foram desalocados/liberados anteriormente.
...
de cada um dos projetos poderá ser visto no anexo \ref{anex:analise_qualitativa}. A seguir uma lista com
